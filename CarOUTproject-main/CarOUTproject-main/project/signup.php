...
if(($password == $cpassword)){
     $sql = "INSERT INTO `users` ( `phoneNo`, `userName`, `fullName`, `email`, `password`) VALUES ('$phoneNo', '$name', '$fullName', '$email', '$password')";
...
if ($showAlert) {
    ...
    <strong>Successfully!</strong> Your account created now you can login.
...
<div class="settings">
    ...
    <div class="personal-information" id="personal">
      <div class="information">
        ...
        <h2>معلومات شخصية</h2>
        <form action="/login-reg/signup.php" method="POST">
          ...
          <h3>أو</h3>
         <a id="login" href="welcome.php" class="submit">تسجل الدخول</a>
